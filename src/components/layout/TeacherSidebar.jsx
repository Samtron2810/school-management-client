...
import {
  ...
  FaCalendarCheck, FaClipboardCheck, FaBullhorn, FaCalendarAlt,
  FaEdit, FaSignOutAlt, FaTimes, FaChevronLeft, FaChevronRight,
} from "react-icons/fa";
import useAuth from "../../hooks/useAuth";

const navItems = [
  { label: "Dashboard", path: "/teacher/dashboard", icon: FaTachometerAlt },
  { label: "My Classes", path: "/teacher/my-classes", icon: FaChalkboardTeacher },
  ...
  { label: "Assessments", path: "/teacher/assessments", icon: FaClipboardCheck },
  { label: "Mark Entries", path: "/teacher/mark-entries", icon: FaEdit },
  ...
  { label: "Report Cards", path: "/teacher/report-cards", icon: FaClipboardCheck },
