...
import {
  FaTachometerAlt, FaChalkboardTeacher, FaBook, FaCalendarCheck,
  FaClipboardCheck, FaBullhorn, FaCalendarAlt, FaUserGraduate,
  FaSignOutAlt, FaTimes, FaChevronLeft, FaChevronRight,
} from "react-icons/fa";
import useAuth from "../../hooks/useAuth";

const navItems = [
  { label: "Dashboard", path: "/student/dashboard", icon: FaTachometerAlt },
  { label: "My Classes", path: "/student/my-classes", icon: FaChalkboardTeacher },
  { label: "My Subjects", path: "/student/my-subjects", icon: FaBook },
  { label: "My Lessons", path: "/student/my-lessons", icon: FaBook },
  { label: "My Assessments", path: "/student/my-assessments", icon: FaClipboardCheck },
  ...
  { label: "Report Cards", path: "/student/report-cards", icon: FaUserGraduate },
