import { FaSchool, FaClipboardCheck, FaFileAlt, FaBook } from "react-icons/fa";
  ...
  return (
    <div>
      ...
      {!schoolClass && (
        <Card className="mb-6 border-l-4 border-accent">
          <p className="text-sm text-slate-gray">
            You are not enrolled in a class for the current session and term
            yet. Some features unlock once an admin enrolls you.
          </p>
        </Card>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <Link
          to="/student/my-lessons"
          className="block p-5 rounded-xl bg-accent text-white hover:bg-accent/80 transition-colors"
        >
        ...
        <Link
          ...
          className="block p-5 rounded-xl bg-accent text-white hover:opacity-90 transition-opacity"
        >
