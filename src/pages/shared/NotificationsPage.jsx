  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          unreadCount > 0 ? (
            <Button variant="outline" icon={FaCheckDouble} onClick={handleMarkAll}>
              Mark all read
            </Button>
          ) : null
        }
          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-start gap-3 px-4 sm:px-5 py-4 text-left transition-colors hover:bg-gray-50 ${
