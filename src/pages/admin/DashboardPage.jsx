...
import ActivityPanels, { DistributionBars } from "../../components/dashboard/ActivityPanels";
...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { icon: FaChalkboardTeacher, title: "Teachers", value: summary.teachers ?? 0 },
    ...
    { icon: FaUserCheck, title: "Enrollments", value: summary.enrollments ?? 0 },
    { icon: FaFileAlt, title: "Results", value: summary.results ?? 0 },
    { icon: FaClipboardList, title: "Assessments", value: summary.assessments ?? 0 },
  ];
    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-gray mt-1">School overview and live statistics</p>
        </div>
        {context && (
          <Badge variant="info">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <DistributionBars title="Grade Distribution" data={chartData.gradeDistribution} />
        <DistributionBars title="Attendance Distribution" data={chartData.attendanceDistribution} />
      </div>
