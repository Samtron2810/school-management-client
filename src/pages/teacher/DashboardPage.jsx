...
export default function TeacherDashboardPage() {
  ...
  const stats = [
    { icon: FaChalkboardTeacher, title: "My Assignments", value: summary.teacherAssignments ?? 0 },
    { icon: FaClipboardCheck, title: "My Assessments", value: summary.assessments ?? 0 },
    { icon: FaFileAlt, title: "My Results", value: summary.results ?? 0 },
    { icon: FaUserGraduate, title: "Attempts (School)", value: summary.attempts ?? 0 },
  ];
    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-gray mt-1">Your classes, assessments, and recent activity</p>
        </div>
        {context && (
          <Badge variant="info">
